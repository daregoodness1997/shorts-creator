...
class EnhancedTextOverlay:
    def __init__(self, video_path="Final.mp4", output_path="test.mp4"):
        ...
        self.config = {
            ...
            "fontsize": 12,
            "color": "white",
            "bg_color": (0, 0, 0, 0.1),  # RGB tuple for black
            "bg_opacity": 0.7,
            "stroke_color": "black",
            "stroke_width": 1,
    ...
    def create_enhanced_video(self, transcriptions=None, fps=30):
        ...
        if transcriptions is None:
            print(
                "❌ Error: No transcriptions provided. Transcriptions must be passed to avoid double processing."
            )
            print(
                "Please call: overlay.create_enhanced_video(transcriptions=your_transcriptions)"
            )
            return
...
def main():
    ...
    sample_transcriptions = [
        [
            " I don't know well, I don't I don't I'm literally trying to check it all on Twitter, and it's all",
            0.0,
            5.5,
        ],
    ...
    overlay = EnhancedTextOverlay(
        video_path="Final.mp4", output_path="enhanced_output.mp4"
    )
